...
*/	
	...
	def 'Excel -> XML - XLS input processFieldNames fromConfiguration'() {
		given:
		this.properties << ['indentFactor':'2']
	...
	def 'Excel -> XML - XLSX input processFieldNames notAvailable'() {
		given:
		this.properties << ['indentFactor':'2']
		this.properties << ['documentName':'MT_CustomOrder']
		this.properties << ['documentNamespace':'urn:equalize:com']
	...
	def 'Excel -> XML - XLSX input onlyValidCharsInXMLName'() {
		given:
		this.properties << ['indentFactor':'2']
		this.properties << ['documentName':'MT_Order']
		this.properties << ['documentNamespace':'urn:equalize:com']
